...
if __name__ == "__main__":
	...
	plt.title('Temperature vs CO2 (Linear Regression) | Location: AFTABNAGAR')
	...
	plt.title('Humidity vs CO2 (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Humidity (%)')
	plt.ylabel('CO2 (PPM)')
	...
	plt.title('Altitude vs CO (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Altitude (Meter)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Temperature vs CO (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Temperature (Celsius)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Humidity vs CO (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Humidity (%)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Altitude vs Air Quality (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Altitude (Meter)')
	...
	plt.title('Temperature vs Air Quality (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Temperature (Celsius)')
	plt.ylabel('Air Quality Value')
	...
	plt.title('Humidity vs Air Quality (Linear Regression) | Location: AFTABNAGAR')
	plt.xlabel('Humidity (%)')
	plt.ylabel('Air Quality Value')
