...
if __name__ == "__main__":
	...
	plt.title('Temperature vs CO2 (Linear Regression) | Location: UTTARA')
	...
	plt.title('Humidity vs CO2 (Linear Regression) | Location: UTTARA')
	plt.xlabel('Humidity (%)')
	plt.ylabel('CO2 (PPM)')
	...
	plt.title('Altitude vs CO (Linear Regression) | Location: UTTARA')
	plt.xlabel('Altitude (Meter)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Temperature vs CO (Linear Regression) | Location: UTTARA')
	plt.xlabel('Temperature (Celsius)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Humidity vs CO (Linear Regression) | Location: UTTARA')
	plt.xlabel('Humidity (%)')
	plt.ylabel('CO (PPM)')
	...
	plt.title('Altitude vs Air Quality (Linear Regression) | Location: UTTARA')
	plt.xlabel('Altitude (Meter)')
	...
	plt.title('Temperature vs Air Quality (Linear Regression) | Location: UTTARA')
	plt.xlabel('Temperature (Celsius)')
	plt.ylabel('Air Quality Value')
	...
	plt.title('Humidity vs Air Quality (Linear Regression) | Location: UTTARA')
	plt.xlabel('Humidity (%)')
	plt.ylabel('Air Quality Value')
